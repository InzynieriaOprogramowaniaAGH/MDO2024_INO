...
Ćwiczenie zaczynamy od instalacji systemu operacyjnego Fedora 40 w sposób nadzorowany przy użyciu netinst, pozwoli to nam na ustawienie wszystkich potrzebnych parametrów do instalacji nienadzorowanej, która jest głównym celem naszego ćwiczenia.
